...
final class TrackersCollectionViewCell: UICollectionViewCell {
    ...
    private let trackersDaysAmount: UILabel = {
        ...
        trackersDaysAmount.textColor = .ypBlack
    ...
    private let trackerDescription: UILabel = {
        ...
        trackerDescription.textColor = .ypWhite
    ...
    func configure(tracker: Tracker, isCompletedToday: Bool, completedDays: Int, indexPath: IndexPath) {
        ...
        let image = isCompletedToday ? (UIImage(named: "tracker_done")?.withTintColor(trackerCard.backgroundColor ?? .ypWhite)) : (UIImage(named: "plus")?.withTintColor(trackerCard.backgroundColor ?? .ypWhite))
